...
> 사용자는 **필요한 리소스를 자신의 책임 하에 구비**해야 하며, 이로 인해 발생하는 모든 법적 책임은 사용자 본인에게 있습니다.
...
The character Speaki is from the game 'Trickal Revive, Trickcal:Chibi Go' (트릭컬 리바이브) by [EPID GAMES](https://epidgames.com/)
